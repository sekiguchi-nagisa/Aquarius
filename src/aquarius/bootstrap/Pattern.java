...
/**
 * represent a rule of grammar.
 * contains parsing expression
...
public class Pattern {
	 ...
	 * not null
	 */
	private final ParsingExpression innerExpression;

	/**
	 * may be null. if null, this pattern does not contain action.
	 */
	private final ParsingActionSet actionSet;

	private Pattern(ParsingActionSet actionSet, ParsingExpression expr) {
	...
	public static Pattern of(ParsingActionSet actionSet, ParsingExpression expr) {
		return new Pattern(actionSet, expr);
	}

	public static Pattern of(ParsingExpression expr) {
		return Pattern.of(null, expr);
	}
	...
	class andPredictAction extends abstractAction {	// extended expression type
		private andPredictAction(int index) {
			super(index);
		}
	...
	class notPredictAction extends abstractAction {	// extended expression type
		private notPredictAction(int index) {
			super(index);
		}
