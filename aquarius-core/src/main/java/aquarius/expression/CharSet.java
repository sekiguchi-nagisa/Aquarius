...
public class CharSet implements ParsingExpression<Void> {
    ...
    /**
     * @param chars must be utf8 character
     */
    ...
    /**
     * @param start java utf16 character
     * @param stop  java utf16 character
     * @return this
     */
     ...
     * add char range
     *
     * @param start inclusive. must be utf8 character.
     * @param stop  inclusive. must be utf8 character.
     * @return this
     * @throws IllegalArgumentException if start or stop is not utf8 code
     *                                  if start >= stop
     */
